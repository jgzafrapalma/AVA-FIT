...
def evaluation_Fit3D(predictions_path, gt_smplx_path, output_path, 
                     participants = None, exercises = None, viewpoints = None, overwrite = False):
...
def main(args):
    ...
    evaluation_Fit3D(PREDICTIONS_PATH, SMPLX_PATH, SAVE_PATH, args.participants, args.exercises, args.viewpoints, args.overwrite)
