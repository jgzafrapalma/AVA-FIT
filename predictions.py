...
def get_args():
    parser = argparse.ArgumentParser(description="Get predictions from 3D human mesh estimation models")
    ...
    parser.add_argument("--repetitions", nargs='+', required=False, help="Repetitions to process (only AVAFIT)")
...
def main(args):
    ...
    dataset_name = pathlib.Path(args.dataset_path).name
